/* Seleção de elementos do DOM para entrada de dados e exibição das informações climáticas */
...
/* uso de hadware para detectar se o usuario não está com acesso a internet*/
...
/* usando uma função add um recurso de hardware - localização real */
async function buscarClimaPorCoordenadas(lat, lon) {
  try {
    ...
    atualizarTela(dados, { name: "Sua localização" });
